...
import com.test.hooktest.utils.FileType;
import com.test.hooktest.utils.FileUtil;
...
public class SharedPrefsHook extends XC_MethodHook {
    ...
    public static void loadPrefs() {
        sPrefs = new XSharedPreferences(Main.class.getPackage().getName(), Main.PREFS);
        ...
        findAndHookMethod("android.app.SharedPreferencesImpl", loadPackageParam.classLoader, "getBoolean",
                String.class, "boolean", new XC_MethodHook() {
                    ...
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        Main.sPrefs.reload();
                        String[] strReplace = Main.sPrefs.getString("prefs_replace", "").split(",");
